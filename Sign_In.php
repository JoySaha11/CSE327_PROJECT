<?php 
    /*
        Conncect sql file with database
    */
   ...
   Fetch the id and password if the correct id and password then login
   ...
   */
   if (isset($_POST['Signin'])) {
    ...
    /* 
    If the login succesfull entry the homepage
    */
    ...
    /*
     When admin login connect the admin dashboard
    */
