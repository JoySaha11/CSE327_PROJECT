...
if(isset($_POST['add_artwork'])){
   ...
   /**
     * variable declare for admin artwork upload page.
     * insert the value from view_art table
     * message show three types.
     * when @empty please fill out all.
     * or insert the value and show new artwork added.
     * otherwise could not add the artwork
   */
   ...
   /**
     * if you want to delete any artwork then fetch the artwork id.
     * connect header file and fetch location.
   */
...
<div class="container">
   ...
   /**
      * for edit connect artwork update page.
      * for delete connect the artwork upload page.
   */
